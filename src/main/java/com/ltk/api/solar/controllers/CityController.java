...
public class CityController {
    ...
    @GetMapping
    public ResponseEntity<Page<CityResponseTo>> getAll(@PageableDefault(page = 0, size = 20, sort = {"state.name", "name"}, direction = Sort.Direction.ASC) Pageable pageable) {
    ...
    public ResponseEntity<Object> findById(@PathVariable(value = "id") String id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(cityResponseTo);
    }
